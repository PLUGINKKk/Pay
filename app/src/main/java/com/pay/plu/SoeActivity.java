...
public class SoeActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		k = MediaPlayer.create(getApplicationContext(), R.raw.bra);
		k.start();
	...
	public class GameView extends View{
		...
		protected void onDraw(Canvas canvas) {
			...
			android.graphics.drawable.Drawable d = getResources().getDrawable(R.drawable.bop_1, null);
			...
			for (int i = 0; i<otherCars.size(); i++){
				...
				android.graphics.drawable.Drawable d2 = getResources().getDrawable(R.drawable.bop_4, null);
