...
public class ZawActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		k = MediaPlayer.create(getApplicationContext(), R.raw.gam);
		k.start();
		...
		linear1.addView(bcv);
		_NavStatusBarColor("#00FCFF", "#404040");
	}
	...
	public class GameView extends View{
		...
		protected void onDraw(Canvas canvas) {
			...
			android.graphics.drawable.Drawable d = getResources().getDrawable(R.drawable.ako_5, null);
			...
			for (int i = 0; i<otherCars.size(); i++){
				...
				android.graphics.drawable.Drawable d2 = getResources().getDrawable(R.drawable.ako_6, null);
