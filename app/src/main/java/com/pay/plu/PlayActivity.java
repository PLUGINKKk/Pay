...
public class PlayActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		k = MediaPlayer.create(getApplicationContext(), R.raw.bko);
		k.start();
		...
		linear1.addView(bcv);
		_NavStatusBarColor("#FF3F51B5", "#404040");
	}
	...
	public class GameView extends View{
		...
		protected void onDraw(Canvas canvas) {
			...
			android.graphics.drawable.Drawable d = getResources().getDrawable(R.drawable.ico, null);
			...
			for (int i = 0; i<otherCars.size(); i++){
				...
				android.graphics.drawable.Drawable d2 = getResources().getDrawable(R.drawable.mon_1, null);
